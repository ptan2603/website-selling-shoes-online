...
// dùng để gọi lại, tìm kiếm thay đổi, danh sách sản phẩm  sẽ được cập nhật dựa trên tên sản phẩm.
  useEffect(() => {
      ...
      <div className="container-fluid padding">
        <div className="row welcome mini-card">
          <div className="text-danger" >
            <h4 className="title" style={{ color: "red" }}>Kết quả tìm kiếm</h4>
          </div>
        </div>
      </div>
                ...
                <div className="card h-100 mini-pro">
                  ...
                  <div className="card-body px-2 pb-2 pt-1">
                    ...
                    <div className="d-flex justify-content-between">
                      ...
                      <div className="ml-2">
                        <NavLink to="#" className="btn btn-outline-success" data-toggle="tooltip" data-placement="left"

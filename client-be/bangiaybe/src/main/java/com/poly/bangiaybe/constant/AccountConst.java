...
public class AccountConst {
    ...
    public static final String API_ACCOUNT_FIND_BY_USERNAME = "/api/account/find-by-username";
    public static final String API_ACCOUNT_REGISTER = "/api/account/register";
    public static final String API_ACCOUNT_FIND_ME = "/api/me";
    public static final String API_ACCOUNT_TOTAL_PAGE = "/api/admin/account/get-total-page";
    
    public static final String API_ACCOUNT_DETAIL_GET_BY_ACCOUNT_ID = "/api/account/detail";
